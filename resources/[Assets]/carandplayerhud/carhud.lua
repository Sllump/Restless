...
RegisterNetEvent("cool-hud:initHud")
AddEventHandler("cool-hud:initHud", function()
  print("[cool-hud] Init hud...")
  ...
  if hasStarted then
    print("[cool-hud] Fully started, and init.")
    --Wait(100)
...
AddEventHandler("buffs:triggerBuff", function(item)
  ...
  TriggerEvent("cool-buffs:addUIBuff", { buffedHunger = true, buffedThirst = true })
  Citizen.CreateThread(function()
    Citizen.Wait(60000 * 60 * 6) -- 6hr
    buffStartTime = 0
    TriggerEvent("cool-buffs:addUIBuff", { buffedHunger = false, buffedThirst = false })
  end)
end)
...
AddEventHandler("buffs:triggerBuff", function(item)
  ...
  TriggerEvent("cool-buffs:addUIBuff", { buffedHealth = true, buffedArmor = true })
  Citizen.CreateThread(function()
    Citizen.Wait(60000 * 60 * 6) -- 3hr
    citrineStartTime = 0
    TriggerEvent("cool-buffs:addUIBuff", { buffedHealth = false, buffedArmor = false })
  end)
end)
