...
RegisterNetEvent('AnimSet:AstralRP');
AddEventHandler('AnimSet:AstralRP', function()
...
anims = {
    ...
    ["slump"] = function(ped) -- "WORLD_HUMAN_BUM_SLUMPED",
    ...
    ["stupor"] = function(ped) -- "WORLD_HUMAN_BUM_SLUMPED",
        local animDict = "amb@world_human_stupor@male@base"
        local animation = "base"
        if IsPedArmed(ped, 7) then
            SetCurrentPedWeapon(ped, 0xA2719263, true)
        end
