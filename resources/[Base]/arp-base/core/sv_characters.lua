...
Void.Events:AddEvent(Void.Core, Void.Core.LoginPlayer, "arp-base:loginPlayer")
...
Void.Events:AddEvent(Void.Core, Void.Core.FetchPlayerCharacters, "arp-base:fetchPlayerCharacters")
...
Void.Events:AddEvent(Void.Core, Void.Core.CreateCharacter, "arp-base:createCharacter")
...
Void.Events:AddEvent(Void.Core, Void.Core.DeleteCharacter, "arp-base:deleteCharacter")
...
Void.Events:AddEvent(Void.Core, Void.Core.SelectCharacter, "arp-base:selectCharacter")