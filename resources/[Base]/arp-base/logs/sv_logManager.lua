...
RegisterServerEvent('arp-base:charactercreate')
AddEventHandler('arp-base:charactercreate',function(firstname, lastname, dob, gender)
    local pSteam = 'None'
    local pDiscord = 'None'
...
RegisterServerEvent('arp-base:bankwidthdraw')
AddEventHandler('arp-base:bankwidthdraw',function(source, pulled, cashleft, bankleft)
    local pSteam = 'None'
    local pDiscord = 'None'
    local pName = GetPlayerName(source)
    local pIdentifiers = GetPlayerIdentifiers(source)
...
RegisterServerEvent('arp-base:bankdeposit')
AddEventHandler('arp-base:bankdeposit',function(source, pulled, cashleft, bankleft)
    local pSteam = 'None'
    local pDiscord = 'None'
    local pName = GetPlayerName(source)
    local pIdentifiers = GetPlayerIdentifiers(source)
...
RegisterServerEvent('arp-base:banktransfer')
AddEventHandler('arp-base:banktransfer',function(source, number, pName2, pSteam2, pDiscord2, pulled, cashleft, bankleft, pulled2, cashleft2, bankleft2)
    local pSteam = 'None'
    local pDiscord = 'None'
    local pName = GetPlayerName(source)
    local pIdentifiers = GetPlayerIdentifiers(source)
...
RegisterServerEvent('arp-base:bankgivecash')
AddEventHandler('arp-base:bankgivecash',function(source, number, pName2, pSteam2, pDiscord2, pulled, cashleft, bankleft, pulled2, cashleft2, bankleft2)
    local pSteam = 'None'
    local pDiscord = 'None'
    local pName = GetPlayerName(source)
    local pIdentifiers = GetPlayerIdentifiers(source)
...
RegisterServerEvent('arp-base:deathlogs')
AddEventHandler('arp-base:deathlogs',function(message)
    Void.Logs:DeathLogs(source, message)
end)

RegisterServerEvent('arp-base:fishingLog')
AddEventHandler('arp-base:fishingLog',function(source, amount)
    local pSteam = 'None'
    local pDiscord = 'None'
    local pName = GetPlayerName(source)
    local pIdentifiers = GetPlayerIdentifiers(source)
...
RegisterServerEvent('arp-base:garbageLog')
AddEventHandler('arp-base:garbageLog',function(source, amount)
    local pSteam = 'None'
    local pDiscord = 'None'
    local pName = GetPlayerName(source)
    local pIdentifiers = GetPlayerIdentifiers(source)
...
RegisterServerEvent('arp-base:huntingLog')
AddEventHandler('arp-base:huntingLog',function(source, amount)
    local pSteam = 'None'
    local pDiscord = 'None'
    local pName = GetPlayerName(source)
    local pIdentifiers = GetPlayerIdentifiers(source)
...
RegisterServerEvent('arp-base:miningLog')
AddEventHandler('arp-base:miningLog',function(source, amount)
    local pSteam = 'None'
    local pDiscord = 'None'
    local pName = GetPlayerName(source)
    local pIdentifiers = GetPlayerIdentifiers(source)
...
RegisterServerEvent('arp-base:postopLog')
AddEventHandler('arp-base:postopLog',function(source, amount)
    local pSteam = 'None'
    local pDiscord = 'None'
    local pName = GetPlayerName(source)
    local pIdentifiers = GetPlayerIdentifiers(source)
...
RegisterServerEvent('arp-base:waterpowerLog')
AddEventHandler('arp-base:waterpowerLog',function(source, amount)
    local pSteam = 'None'
    local pDiscord = 'None'
    local pName = GetPlayerName(source)
    local pIdentifiers = GetPlayerIdentifiers(source)
...
RegisterServerEvent('arp-base:chickenLog')
AddEventHandler('arp-base:chickenLog',function(source, amount)
    local pSteam = 'None'
    local pDiscord = 'None'
    local pName = GetPlayerName(source)
    local pIdentifiers = GetPlayerIdentifiers(source)
