...
function Void.DataControls.setBindTable(controlTable,shouldSend)
	if controlTable == nil then
		...
		TriggerServerEvent('arp-base:sv:player_control_set',Void.Controls.Current)
...
RegisterNetEvent("arp-base:cl:player_control")
AddEventHandler("arp-base:cl:player_control", function(controlTable)
...
AddEventHandler('arp-base:setcontrols', function()
	TriggerServerEvent('arp-base:sv:player_controls')
end)
