...
function Void.SettingsData.setSettingsTable(settingsTable, shouldSend)
  if settingsTable == nil then
    ...
    TriggerServerEvent('arp-base:sv:player_settings_set',Void.Settings.Current)
...
RegisterNetEvent("arp-base:cl:player_settings")
AddEventHandler("arp-base:cl:player_settings", function(settingsTable)
  Void.SettingsData.setSettingsTable(settingsTable,false)
end)


RegisterNetEvent("arp-base:cl:player_reset")
AddEventHandler("arp-base:cl:player_reset", function(tableName)
