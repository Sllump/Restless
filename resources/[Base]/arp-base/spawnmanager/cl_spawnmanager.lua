...
function Void.SpawnManager.Initialize(self)
    Citizen.CreateThread(function()
        ...
        TriggerEvent("arp-base:spawnInitialized")
        TriggerServerEvent("arp-base:spawnInitialized")
        TriggerServerEvent('arp-scoreboard:updatePlayerCount')
    end)
end
...
RegisterNetEvent('arp-base:clearStates')
AddEventHandler('arp-base:clearStates', function()
