...
Citizen.CreateThread(function()
    ...
    -- RegisterCommand('-showPlayerList', function() end, false)
    -- exports["arp-binds"]:registerKeyMapping("PlayerList", "Player", "View Online Players", "+showPlayerList", "-showPlayerList", "U", true)

    RegisterCommand('+generalUse', function() end, false)
    RegisterCommand('-generalUse', function() end, false)
    exports["arp-binds"]:registerKeyMapping("general", "Player", "General Use", "+generalUse", "-generalUse", "E", true)

    RegisterCommand('+housingMain', function() end, false)
    RegisterCommand('-housingMain', function() end, false)
    exports["arp-binds"]:registerKeyMapping("housingMain", "Housing", "Housing Main", "+housingMain", "-housingMain", "H", true)

    RegisterCommand('+housingSecondary', function() end, false)
    RegisterCommand('-housingSecondary', function() end, false)
    exports["arp-binds"]:registerKeyMapping("housingSecondary", "Housing", "Housing Secondary", "+housingSecondary", "-housingSecondary", "G", true)

    RegisterCommand('+generalUseThird', function() end, false)
    RegisterCommand('-generalUseThird', function() end, false)
    exports["arp-binds"]:registerKeyMapping("generalUseThird", "Player", "General Use Third", "+generalUseThird", "-generalUseThird", "G", true)

    exports["arp-binds"]:registerKeyMapping("", "Radio", "Open", "+handheld", "-handheld", "O")
    RegisterCommand('+handheld', handheld, false)
    RegisterCommand('-handheld', function() end, false)
    
    --exports["arp-binds"]:registerKeyMapping("", "Phone", "Open", "+generalPhone", "-generalPhone", "P")
    --RegisterCommand('+generalPhone', generalPhone, false)
    --RegisterCommand('-generalPhone', function() end, false)
    
    exports["arp-binds"]:registerKeyMapping("", "Inventory", "Open", "+generalInventory", "-generalInventory", "K")
    RegisterCommand('+generalInventory', generalInventory, false)
    RegisterCommand('-generalInventory', function() end, false)
    
    -- exports["arp-binds"]:registerKeyMapping("", "Player", "Escape menu", "+generalEscapeMenu", "-generalEscapeMenu", "ESCAPE")
...
function generalPhone()
    if exports["arp-inventory"]:hasEnoughOfItem("mobilephone",1,false) then 
        if not isHandcuffed and not isSoftCuffed then
            if not exports['arp-death']:GetDeathStatus() then
...
function generalInventory()
    if not exports['arp-death']:GetDeathStatus() and not exports['arp-taskbar']:pInInv() then
