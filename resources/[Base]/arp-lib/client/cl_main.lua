...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('arp-lib:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('arp-lib:cl_response')
AddEventHandler('arp-lib:cl_response', function(origin, callId, response)
