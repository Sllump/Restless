...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('arp-rpc:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('arp-rpc:cl_response')
AddEventHandler('arp-rpc:cl_response', function(origin, callId, response)
