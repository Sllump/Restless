...
RegisterNetEvent('arp-lib:cl_request')
AddEventHandler('arp-lib:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('arp-lib:cl_response', src, origin, callId, response)
end)