...
RegisterNetEvent('arp-rpc:cl_request')
AddEventHandler('arp-rpc:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('arp-rpc:cl_response', src, origin, callId, response)
end)