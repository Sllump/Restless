...
local vehshopOwner = {
	...
	menu = {
		...
		["s-class"] = {
            ...
            name = "s-class",
            buttons = {
                {name = "Bravado Gauntlet Classic", costs = 177500, description = {}, model = "gauntlet3"}, -- A
                {name = "Grotti Furia", costs = 182500, description = {}, model = "furia"}, -- S
                {name = "Vulcar Nebula Turbo", costs = 175000, description = {}, model = "nebula"}, -- S
                {name = "Grotti Turismo Classic", costs = 185000, description = {}, model = "turismo2"}, -- A
                {name = "Itali GTO", costs = 225000, description = {}, model = "italigto"}, -- A
                {name = "Itali RSX", costs = 230000, description = {}, model = "italirsx"},
                {name = "Gauntlet HELFIRE", costs = 190000, description = {}, model = "gauntlet4"},
                {name = "Comet SR", costs = 1825000, description = {}, model = "comet5"},
                {name = "Dominator GTX", costs = 185000, description = {}, model = "dominator3"},
                {name = "Jester Retro", costs = 175000, description = {}, model = "jester3"},
                {name = "Drafter", costs = 180000, description = {}, model = "Drafter"},
                {name = "Jester RR", costs = 215000, description = {}, model = "Jester4"},
                {name = "Dominator ASP", costs = 187500, description = {}, model = "Dominator7"},
                {name = "Vectre", costs = 195000, description = {}, model = "Vectre"},
                {name = "Sultan RS", costs = 215000, description = {}, model = "SultanRS"},
                {name = "ZR350", costs = 187500, description = {}, model = "ZR350"},
                {name = "Elegy Retro Custom", costs = 225000, description = {}, model = "elegy"},
                {name = "Progen T20", costs = 210000, description = {}, model = "T20"},
                {name = "Remus", costs = 185000, description = {}, model = "Remus"},
                {name = "RT3000", costs = 182500, description = {}, model = "RT3000"},
                {name = "Dominator GTT", costs = 180000, description = {}, model = "DOMINATOR8"},
                {name = "Annis Euros", costs = 217500, description = {}, model = "EUROS"},
                {name = "Futo GTX", costs = 175000, description = {}, model = "Futo2"},
                {name = "Calico GTF", costs = 180000, description = {}, model = "Calico"},
                {name = "Comet S2", costs = 180000, description = {}, model = "COMET6"},
                {name = "UBERMACHT Cypher", costs = 200000, description = {}, model = "Cypher"},
                {name = "Growler", costs = 190000, description = {}, model = "Growler"},
                {name = "Sultan RS classic", costs = 205000, description = {}, model = "Sultan3"},
                {name = "Banshee 900R", costs = 210000, description = {}, model = "banshee2"},
                {name = "Coquette D10", costs = 235000, description = {}, model = "coquette4"},
                {name = "Schlagen GT", costs = 205000, description = {}, model = "Schlagen"},
                {name = "Infernus Classic", costs = 207500, description = {}, model = "infernus2"},
                {name = "Deviant", costs = 195000, description = {}, model = "deviant"},
                {name = "Grotti Turismo R", costs = 190000, description = {}, model = "turismor"},
            }
		},
        ["b-class"] = {
			title = "b-class",
...
--				{name = "VSTR", costs = 186000, description = {}, model = "vstr"},
		...
		["d-class"] = {
			...
			buttons = {
				...
				{name = "Exclusive Taxi (Omar Only)", costs = 12000, description = {}, model = "dilettante3"},
			}
		},
		["offroad"] = {
			title = "off-road",
		...
		["a-class"] = {
			...
			buttons = {
				...
				{name = "Lynx", costs = 112500, description = {}, model = "lynx"},
				{name = "Sentinel Classic", costs = 100000, description = {}, model = "sentinel3"}
			}
		},
		["motorcycles"] = {
			title = "MOTORCYCLES",
...
function updateCarTable(model,price,name)
	for i=1, #carTable do
		...
		TriggerServerEvent("arp-pdm:CarTablePDM",carTable)
	end
end

local myspawnedvehs = {}

RegisterNetEvent("arp-pdm:testdrive")
AddEventHandler("arp-pdm:testdrive", function()
	if exports["arp-business"]:IsEmployedAt("pdm") or #(vector3(-23.69871, -1094.529, 27.305231) - GetEntityCoords(PlayerPedId())) > 50.0 then
...
RegisterNetEvent("arp-pdm:EnableBuy")
AddEventHandler("arp-pdm:EnableBuy", function()
	if #(vector3(-23.69871, -1094.529, 27.305231) - GetEntityCoords(PlayerPedId())) > 50.0 and exports["arp-business"]:IsEmployedAt("pdm") then
		return
	end
	...
	TriggerServerEvent("arp-pdm:BuyEnabledSV",vehplate)
end)

RegisterNetEvent("arp-pdm:BuyEnabledCL")
AddEventHandler("arp-pdm:BuyEnabledCL", function(addplate)
	buyPlate[addplate] = true
	Citizen.Wait(60000)
	buyPlate[addplate] = nil
end)

RegisterNetEvent("arp-pdm:PDMCommission")
AddEventHandler("arp-pdm:PDMCommission", function(newAmount)
	if eexports["arp-business"]:IsEmployedAt("pdm") or #(vector3(-23.69871, -1094.529, 27.305231) - GetEntityCoords(PlayerPedId())) > 50.0 then
...
RegisterNetEvent("arp-pdm:ReturnPDMTTable")
AddEventHandler("arp-pdm:ReturnPDMTTable", function(newTable)
	carTable = newTable
	DespawnSaleVehicles()
	SpawnSaleVehicles()
end)
...
function AttemptBuy(tableid)
	...
	TaskWarpPedIntoVehicle(PlayerPedId(),veh,-1)
	TriggerEvent("vehicle:keys:addNew",veh, plate)
	TriggerServerEvent('arp-pdm:ChechMoney',name, model, price)
	commissionbuy = (baseprice * commission / 100)
	Citizen.Wait(100)
	exports['arp-interface']:hideInteraction()
	TriggerServerEvent('arp-banking:business_money', price, 'pdm', 'add')
end
...
function DrawPrices()
	for i = 1, #carspawns do
		if #(vector3(carspawns[i]["x"],carspawns[i]["y"],carspawns[i]["z"]) - GetEntityCoords(PlayerPedId())) < 1.5 then
			...
			if exports["arp-business"]:IsEmployedAt("pdm") then
				if buyPlate[addplate] ~= nil then
					exports['arp-interface']:showInteraction("$" .. math.ceil(price) .. " | Com: %" ..commission.. " | [E] to change | [G] to buy.")
				else
					exports['arp-interface']:showInteraction("$" .. math.ceil(price) .. " | Com: %" ..commission.. " | [E] to change")
				end
			else
				if buyPlate[addplate] ~= nil then
					exports['arp-interface']:showInteraction("$" .. math.ceil(price) .. " [G] to buy.")
				else
					exports['arp-interface']:showInteraction("Buy Price: $" .. math.ceil(price) .. " ")
				end
			end
...
function SpawnSaleVehicles()
	if not hasspawned then
		TriggerServerEvent("arp-pdm:RequestPDMTTable")
		Citizen.Wait(1500)
	end
...
function CloseCreator(name, veh, price, plate)
	Citizen.CreateThread(function()
		...
		if not boughtcar then
			...
			-- local VehicleProps = exports['arp-base']:FetchVehProps(personalvehicle)
			...
			--TriggerServerEvent('arp-pdm:BuyVehicle', plate, name, vehicle, price) -- make this rpc, and await response
			local result = RPC.execute("arp-pdm:BuyVehicle", vehicle, tbl)
			DespawnSaleVehicles()
			SpawnSaleVehicles()
			Citizen.Wait(100)
			exports['arp-interface']:hideInteraction()
...
RegisterNetEvent("arp-pdm:FailedPurchase")
AddEventHandler("arp-pdm:FailedPurchase", function()
...
function ButtonSelected(button)
	...
	elseif this == "jobvehicles" or this == "s-class" or this == "a-class" or this == "b-class" or this == "c-class" or this == "casino" or this == "d-class" or this == "offroad" or this == "suvs" or this == "vans" or this == "industrial" or this == "cycles" or this == "motorcycles" then
		if ownerMenu then
			...
			TriggerServerEvent('arp-pdm:ChechMoney',button.name, button.model, button.costs)
		end
	end
end
	...
	while true do
		...
		if vehshop.opened then
			...
			for i,button in pairs(menu.buttons) do
				...
				if exports["arp-business"]:IsEmployedAt("pdm") and i >= vehshop.menu.from and i <= vehshop.menu.to then
...
RegisterCommand('commission', function(source, args, raw)
	if exports["arp-business"]:IsEmployedAt("pdm") then
		...
		if tonumber(amount) > 0 and tonumber(amount) <= 60 then
			TriggerEvent('arp-pdm:PDMCommission', amount)
		else
...
RegisterCommand('testdrive', function(source, args, raw)
	if exports["arp-business"]:IsEmployedAt("pdm") then
		TriggerEvent('arp-pdm:testdrive')
	else
		TriggerEvent('DoLongHudText', 'You dont have permissions for this!', 2)
	end
end)
...
RegisterCommand('enableBuy', function(source, args, raw)
	if exports["arp-business"]:IsEmployedAt("pdm") then
		TriggerEvent('arp-pdm:EnableBuy')
	else
		TriggerEvent('DoLongHudText', 'You dont have permissions for this!', 2)
	end
end)