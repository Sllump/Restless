...
RegisterNetEvent("arp-scoreboard:playerscount")
AddEventHandler("arp-scoreboard:playerscount", function(a)
    playerOnline = a
end)
...
RegisterNetEvent("arp-scoreboard:RemovePlayer")
AddEventHandler("arp-scoreboard:RemovePlayer", function(data)
    Void.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("arp-scoreboard:AddPlayer")
AddEventHandler("arp-scoreboard:AddPlayer", function(data)
    Void.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("arp-scoreboard:RemoveRecent")
AddEventHandler("arp-scoreboard:RemoveRecent", function(src)
    Void.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("arp-scoreboard:AddAllPlayers")
AddEventHandler("arp-scoreboard:AddAllPlayers", function(data)
