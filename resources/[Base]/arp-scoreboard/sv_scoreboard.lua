...
RegisterServerEvent('arp-scoreboard:AddPlayer')
AddEventHandler("arp-scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("arp-scoreboard:AddPlayer", -1, data )
...
function Void.Scoreboard.AddAllPlayers(self)
    ...
    for i, _PlayerId in pairs(GetPlayers()) do
        ...
        TriggerClientEvent("arp-scoreboard:AddAllPlayers", source, data)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("arp-scoreboard:RemovePlayer", -1, data )
    TriggerEvent('arp-scoreboard:updatePlayerCount')
    Wait(600000)
    TriggerClientEvent("arp-scoreboard:RemoveRecent", -1, plyid)
end)
...
RegisterServerEvent('arp-scoreboard:updatePlayerCount')
AddEventHandler("arp-scoreboard:updatePlayerCount", function()
    local playersonline = GetNumPlayerIndices()
    TriggerClientEvent("arp-scoreboard:playerscount", -1, playersonline)
end)