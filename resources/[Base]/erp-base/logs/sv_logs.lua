function DiscordLog(wh, pSrc, reason, pBanReason, pLogData)
    local user = exports["erp-base"]:getModule("Player"):GetUser(pSrc)
    if user ~= false then
...
--     exports['erp-base']:DiscordLog("DiscordLink", attacker, "damage_multi", pLogData)
--     DropPlayer(attacker, "[erp-anticheat] | Ban Reason: Damage Modifier")
-- end)
...
--                 exports['erp-base']:DiscordLog("DiscordLink", pOwner, "Cheater: Spawned Blacklisted Prop", "Spawning Props", LogInfo)
--                 Citizen.Wait(100)
--                 DropPlayer(pOwner, "[erp-anticheat]: You have been permanently banned.")
--                 break
--             end
--         end
--     end
...
-- RegisterServerEvent("erp-base:receiveItam")
-- AddEventHandler("erp-base:receiveItam", function(pCid, item_id, pAmount)
--     local pSrc = source
--     LogInfo = "Spawned Info |  Item: " ..item_id.. " / Amount: " .. pAmount
--     exports['erp-base']:DiscordLog("DiscordLink", pSrc, "mass-spawn", "Mass Spawning Items", LogInfo)
--     DropPlayer(pSrc, "[erp-anticheat] | Banned | Reason: Better luck next time!")
--     return
-- end)
