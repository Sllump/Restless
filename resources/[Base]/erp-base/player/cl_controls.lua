...
function Void.DataControls.setBindTable(controlTable,shouldSend)
	if controlTable == nil then
		...
		TriggerServerEvent('erp-base:sv:player_control_set',Void.Controls.Current)
...
RegisterNetEvent("erp-base:cl:player_control")
AddEventHandler("erp-base:cl:player_control", function(controlTable)
...
RegisterNetEvent('erp-base:setcontrols')
AddEventHandler('erp-base:setcontrols', function()
	TriggerServerEvent('erp-base:sv:player_controls')
end)
