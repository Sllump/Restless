...
function Void.SettingsData.setSettingsTable(settingsTable, shouldSend)
  if settingsTable == nil then
    ...
    TriggerServerEvent('erp-base:sv:player_settings_set',Void.Settings.Current)
...
RegisterNetEvent("erp-base:cl:player_settings")
AddEventHandler("erp-base:cl:player_settings", function(settingsTable)
  Void.SettingsData.setSettingsTable(settingsTable,false)
end)


RegisterNetEvent("erp-base:cl:player_reset")
AddEventHandler("erp-base:cl:player_reset", function(tableName)
