...
function Void.SpawnManager.Initialize(self)
    Citizen.CreateThread(function()
        ...
        TriggerEvent("erp-base:spawnInitialized")
        TriggerServerEvent("erp-base:spawnInitialized")
        TriggerServerEvent('erp-scoreboard:updatePlayerCount')
    end)
end
...
AddEventHandler("erp-base:firstSpawn", function()
    Void.SpawnManager:InitialSpawn()
end)

RegisterNetEvent('erp-base:clearStates')
AddEventHandler('erp-base:clearStates', function()
