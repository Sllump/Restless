...
Citizen.CreateThread(function()
    ...
    -- RegisterCommand('-showPlayerList', function() end, false)
    -- exports["erp-binds"]:registerKeyMapping("PlayerList", "Player", "View Online Players", "+showPlayerList", "-showPlayerList", "U", true)

    RegisterCommand('+generalUse', function() end, false)
    RegisterCommand('-generalUse', function() end, false)
    exports["erp-binds"]:registerKeyMapping("general", "Player", "General Use", "+generalUse", "-generalUse", "E", true)

    RegisterCommand('+housingMain', function() end, false)
    RegisterCommand('-housingMain', function() end, false)
    exports["erp-binds"]:registerKeyMapping("housingMain", "Housing", "Housing Main", "+housingMain", "-housingMain", "H", true)

    RegisterCommand('+housingSecondary', function() end, false)
    RegisterCommand('-housingSecondary', function() end, false)
    exports["erp-binds"]:registerKeyMapping("housingSecondary", "Housing", "Housing Secondary", "+housingSecondary", "-housingSecondary", "G", true)

    RegisterCommand('+generalUseThird', function() end, false)
    RegisterCommand('-generalUseThird', function() end, false)
    exports["erp-binds"]:registerKeyMapping("generalUseThird", "Player", "General Use Third", "+generalUseThird", "-generalUseThird", "G", true)

    exports["erp-binds"]:registerKeyMapping("", "Radio", "Open", "+handheld", "-handheld", "O")
    RegisterCommand('+handheld', handheld, false)
    RegisterCommand('-handheld', function() end, false)
    
    --exports["erp-binds"]:registerKeyMapping("", "Phone", "Open", "+generalPhone", "-generalPhone", "P")
    --RegisterCommand('+generalPhone', generalPhone, false)
    --RegisterCommand('-generalPhone', function() end, false)
    
    exports["erp-binds"]:registerKeyMapping("", "Inventory", "Open", "+generalInventory", "-generalInventory", "K")
    RegisterCommand('+generalInventory', generalInventory, false)
    RegisterCommand('-generalInventory', function() end, false)
    
    -- exports["erp-binds"]:registerKeyMapping("", "Player", "Escape menu", "+generalEscapeMenu", "-generalEscapeMenu", "ESCAPE")
...
function generalPhone()
    if exports["erp-inventory"]:hasEnoughOfItem("mobilephone",1,false) then 
        if not isHandcuffed and not isSoftCuffed then
            if not exports['erp-death']:GetDeathStatus() then
...
function generalInventory()
    if not exports['erp-death']:GetDeathStatus() and not exports['erp-taskbar']:pInInv() then
