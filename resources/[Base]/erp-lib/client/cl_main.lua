...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('erp-lib:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('erp-lib:cl_response')
AddEventHandler('erp-lib:cl_response', function(origin, callId, response)
