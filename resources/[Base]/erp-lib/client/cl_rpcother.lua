...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('erp-rpc:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('erp-rpc:cl_response')
AddEventHandler('erp-rpc:cl_response', function(origin, callId, response)
