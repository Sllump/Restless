...
RegisterNetEvent('erp-lib:cl_request')
AddEventHandler('erp-lib:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('erp-lib:cl_response', src, origin, callId, response)
end)