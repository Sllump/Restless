...
RegisterNetEvent('erp-rpc:cl_request')
AddEventHandler('erp-rpc:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('erp-rpc:cl_response', src, origin, callId, response)
end)