...
RegisterNetEvent("erp-scoreboard:playerscount")
AddEventHandler("erp-scoreboard:playerscount", function(a)
    playerOnline = a
end)
...
RegisterNetEvent("erp-scoreboard:RemovePlayer")
AddEventHandler("erp-scoreboard:RemovePlayer", function(data)
    Void.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("erp-scoreboard:AddPlayer")
AddEventHandler("erp-scoreboard:AddPlayer", function(data)
    Void.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("erp-scoreboard:RemoveRecent")
AddEventHandler("erp-scoreboard:RemoveRecent", function(src)
    Void.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("erp-scoreboard:AddAllPlayers")
AddEventHandler("erp-scoreboard:AddAllPlayers", function(data)
