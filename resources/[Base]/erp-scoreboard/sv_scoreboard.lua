...
RegisterServerEvent('erp-scoreboard:AddPlayer')
AddEventHandler("erp-scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("erp-scoreboard:AddPlayer", -1, data )
...
function Void.Scoreboard.AddAllPlayers(self)
    ...
    for i, _PlayerId in pairs(GetPlayers()) do
        ...
        TriggerClientEvent("erp-scoreboard:AddAllPlayers", source, data)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("erp-scoreboard:RemovePlayer", -1, data )
    TriggerEvent('erp-scoreboard:updatePlayerCount')
    Wait(600000)
    TriggerClientEvent("erp-scoreboard:RemoveRecent", -1, plyid)
end)
...
RegisterServerEvent('erp-scoreboard:updatePlayerCount')
AddEventHandler("erp-scoreboard:updatePlayerCount", function()
    local playersonline = GetNumPlayerIndices()
    TriggerClientEvent("erp-scoreboard:playerscount", -1, playersonline)
end)