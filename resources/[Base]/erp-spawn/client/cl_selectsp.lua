...
AddEventHandler('spawn:clientSpawnData', function(spawnData)
		...
		--[[if Spawn.housingCoords == nil then
			Spawn.housingCoords = exports["erp-housing"]:retriveHousingTable();
		end]]
...
RegisterNetEvent("erp-spawn:firstspawnyo")
AddEventHandler("erp-spawn:firstspawnyo", function()
    if GetEntityModel(PlayerPedId()) == GetHashKey("mp_f_freemode_01") then
        TriggerEvent("erp-spawn:finishedClothingstuffbish")
    else
        TriggerEvent("erp-spawn:finishedClothingstuff")
    end
end)

RegisterNetEvent('erp-spawn:finishedClothingstuff')
AddEventHandler('erp-spawn:finishedClothingstuff', function()
...
RegisterNetEvent('erp-spawn:finishedClothingstuffbish')
AddEventHandler('erp-spawn:finishedClothingstuffbish', function()
