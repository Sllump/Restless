...
-- local Me_ERP_Log = "https://discord.com/api/webhooks/1001667271128780800/Pj8-EDjj5rskFJsyTPYPRI8PZpCnOFgS3uFsQUsPkrT64MPlFBVq3-x65iGLX5bLV6be"
...
--         }
--     }
--     PerformHttpRequest(Me_ERP_Log, function(err, text, headers) end, 'POST', json.encode({username = "AstralRP",  avatar_url = "https://cdn.discordapp.com/attachments/928946993840132116/930453062403899472/Untitled-1.png",embeds = connect}), { ['Content-Type'] = 'application/json' })
-- end)