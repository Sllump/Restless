...
function NPX.DB.CreateNewCharacter(self, src, data2, hexid, ph, callback)
    ...
    local q = [[
        INSERT INTO characters (owner, first_name, last_name, dob, gender, phone_number)
...
function NPX.DB.FetchCharacterData(self, user, callback)
    ...
    local q = [[SELECT id, owner, first_name, last_name, date_created,  cash, bank, phone_number, dob, gender, new, jail_time FROM characters WHERE owner = @owner]]
    local v = {["owner"] = hexId}
...
function NPX.DB.Something(self, src, callback)
    ...
    local q = [[
        ...
        characters.gender, characters.new, characters.jail_time
        FROM characters
