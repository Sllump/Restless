      ...
      <div className={switchOrientation ? classes.phoneContainerSwitch : classes.phoneContainer} style={{ bottom: ShowPhone ? '12px' : SP.length ? '-540px' : '-1000px', background: 'url('+Background+') 0% 0% / cover repeat'}}>
        ...
        <div style={{zIndex: 501}} className={classes.phoneTopContainer}>
          <div className={classes.phoneTopLeftContainer}>
              <Typography style={{  wordBreak: 'break-word',  fontSize: '0.75rem',  lineHeight: '0',  textShadow:	'rgb(55 71 79) -1px 1px 0px, rgb(55 71 79) 1px 1px 0px, rgb(55 71 79) 1px -1px 0px, rgb(55 71 79) -1px -1px 0px' }} variant='body2'>
                {Time}
              </Typography>
              <div className={classes.phoneTopLeftDivider}>
              <Typography style={{  textAlign: 'right',  fontSize: '0.75rem',  lineHeight: '0',  textShadow:	'rgb(55 71 79) -1px 1px 0px, rgb(55 71 79) 1px 1px 0px, rgb(55 71 79) 1px -1px 0px, rgb(55 71 79) -1px -1px 0px' }} variant='body2'>
                #{Serverid}
              </Typography>
