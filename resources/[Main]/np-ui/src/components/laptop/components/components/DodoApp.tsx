...
const DodoApp = React.memo(({counter, setCounter}: any) => {
    const ref = useRef()
    ...
    return (
        <div>
            <Draggable defaultPosition={{x: -650, y: -400}} handle='.boosting-dodo-buttons'>
                <div className={counter ? '' : 'hiddenComponent'}>
                    <div className='DodoApp'>
                        <div className='boosting-dodo-buttons'  ref={ref}>
                            <div style={{position:'absolute', right:'0'}} className='boosting-close-container'>
