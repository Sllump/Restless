  ...
  return (
    <>
          <div style={{ opacity: ShowPeek ? 1 : 0 }} className={classes.thirdEyeContainer}>
            <img src={Active ? 'https://dvexdev.github.io/DveX.Images/peek-active-1.png' : 'https://dvexdev.github.io/DveX.Images/peek.png'} alt='peek' style={{display: ShowPeek ? '' : 'none',  maxWidth: '2.5vw',  maxHeight: '2.5vw'}}/>
            <div className={classes.thirdEyeOptionsWrapper} style={{ display: Active ? '' : 'none' }}>
              {eyeinteract && eyeinteract.length > 0 
                ...
                : <Typography style={{color: '#fff', wordBreak: 'break-word',  margin: '0'}} variant={'h6'} gutterBottom>
                  No Entries ;(
                </Typography>
              }
            </div>
