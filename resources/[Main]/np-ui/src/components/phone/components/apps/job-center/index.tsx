                  ...
                  return (
                    <div className="activity-task-wrapper">
                      <Timeline>
                        <TimelineItem>
                          <TimelineSeparator>
                            <TimelineDot sx={{ backgroundColor: 'rgb(66, 76, 171)'}} />
                            <TimelineConnector sx={{ backgroundColor: data.completed ? 'rgb(66, 76, 171)' : 'rgb(189, 189, 189)' }} />
                          </TimelineSeparator>
                          <TimelineContent>
                            <div className="component-paper cursor-pointer" style={{ width: '94.6%' }}>
                              <div className="main-container">
                                <div className="details">
                                  <div className="description">
                                    <div className="flex-row">
                                      <Typography style={{ color: '#fff', wordBreak: 'break-word', textDecoration: data.completed ? 'line-through' : 'none' }} variant="body2" gutterBottom>{data.task}</Typography>
                                    </div>
                                  </div>
                                  <div className="description">
                                    <div className="flex-row" style={{ justifyContent: 'flex-end' }}>
                                      <Typography style={{ color: '#fff', wordBreak: 'break-word' }} variant="body1" gutterBottom>{data.completed ? '1/1' : '0/1'}</Typography>
                                    </div>
                                  </div>
                                </div>
