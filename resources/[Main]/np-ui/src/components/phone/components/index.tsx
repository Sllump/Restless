...
import AbdtApp from './apps/abdt';
import CryptoApp from './apps/crypto';
import NotificationIItem from './notification';
import EmploymentApp from './apps/employment/employment';
import EmployeesApp from './apps/employment/employees';
import CalendarApp from './apps/calendar';
import RacingApp from './apps/racing/racing';
import NltsApp from './apps/nlts';
...
function useNotificationManager() {
  ...
  const addNotification = (notification) =>
    setNotifications((notifications: any) => [...notifications, notification]);

  const deleteNotification = (id: number) =>
    setNotifications((notifications) =>
      notifications.filter((m: any) => m.id !== id)
    );
...
const Phone: React.FC = () => {
    ...
    const [Brand, setBrand]: any = useRecoilState(phoneBrandState)
    const [Background, setBackground]: any = useRecoilState(phoneBackgroundState)
      ...
      if ('phone' === data.app) {
        ...
        if('sms-receive' === dvexdata.action){
          addNotification({
            ...
            confirmation: {},
            header: formatPhoneNumber(dvexdata.number),
        ...
        if('email-receive' === dvexdata.action){
          addNotification({ 
            id: notificationInd, 
            isCall: false, 
            calls: { receive: false, dialing: false, progress: false, inactive: false }, 
            isConfirmation: false, 
            confirmation: {}, 
            header: data.subject, 
            content: data.body, 
            ...
            iconColor: "#fff", 
            bgColor: "linear-gradient(0deg, rgba(114,213,227,1) 0%, rgba(0,140,237,1) 100%)" 
          });
    ...
    function openApp(pAppName){
      ...
      setShowApp(false)
      if(pAppName === 'calculator'){
        setSwitchOrientation(false)
      } else if(pAppName === 'calendar'){
        setSwitchOrientation(false)
      }
    }
    ...
    return (
      <>
      <div className={switchOrientation ? classes.phoneContainerSwitch : classes.phoneContainer} style={{ bottom: Show ? '12px' : notifications.length ? '-540px' : '-1000px', background: 'url('+Background+') 0% 0% / cover repeat', backgroundSize: !switchOrientation ? '100% 80%' : '20% 80%'}}>
      <div style={{display: showAddMilkRoadeModel ? '' : 'none'}} className={classes.MilkRoadeModalContainer}>
        ...
        <div style={{zIndex: 501}} className='phone-bottom-container'>
          ...
          <div onClick={function() {if(CurrentApp !== 'calendar' && CurrentApp !== 'calculator'){setSwitchOrientation(!switchOrientation)}}}>
        ...
        <div className='phone-app-container' style={{background: 'rgba(0, 0, 0, 0)'}}>
          <div className={classes.phoneAppInnerContainer}>
            <div style={{display: showApp ? '' : 'none',}} className={switchOrientation ? classes.phoneAppAppsSwitch : classes.phoneAppApps}>
              ...
              <div onClick={function() {openApp('yellow-pages')}} style={{ color: '#fff', textDecoration: 'none' }}>
                <Tooltip sx={{backgroundColor: 'rgba(97, 97, 97, 0.9)', fontSize: '1em', maxWdith: '1000px'}} arrow placement="top" title="Yellow Pages">
              ...
              <div onClick={function() {openApp('crypto')}} style={{ color: '#fff', textDecoration: 'none' }}>
              ...
              <div onClick={function() {openApp('employment')}} style={{ color: '#fff', textDecoration: 'none' }}>
              ...
              <div onClick={function() {openApp('calendar')}} style={{ color: '#fff', textDecoration: 'none' }}>
              ...
              <div onClick={function() {openApp('racing')}} style={{ color: '#fff', textDecoration: 'none' }}>
              ...
              <div onClick={function() {openApp('milk-road')}} style={{ display: showMilkRoade ? '' : 'none', color: '#fff', textDecoration: 'none' }}>
              ...
              <div onClick={function() {openApp('abdt')}} style={{ color: '#fff', textDecoration: 'none' }}>
              ...
              <div onClick={function() {openApp('nlts')}} style={{ color: '#fff', textDecoration: 'none' }}>
              ...
              <div onClick={function() {openApp('calculator')}} style={{ color: '#fff', textDecoration: 'none' }}>
      ...
      <div style={{ display: 'android' === Brand ? '' : 'none', bottom: 'android' === Brand && Show ? '12px' : notifications.length ? '-540px' : '-1000px' }} className={switchOrientation ? 'phone-border-container-switch' : 'phone-border-container'}>
      ...
      <div style={{ display: 'ios' === Brand ? '' : 'none', bottom: 'ios' === Brand && Show ? '0px' : notifications.length ? '-550px' : '-1000px' }} className='phone-iphone-shell'>
