...
--    {id = "Smelting", name = "Smelting", color = 17, sprite = 52, x = 1098.10168457031, y=-1999.86364746094, z=30.3807010650635},
    ...
    {id = "ttruckjob", name = "Impound Lot", color = 17, sprite = 68, x =1001.91, y = -2311.0, z = 30.78},
    ...
    {id = "airshop", name = "LSIA Flights", scale = 0.7, color = 41, sprite = 307, x=-1040.37, y=-2507.21, z=13.03},
