    ...
    return (
      <div>
        <div>
          ...
          > 
          <div onClick={handleClick} className="relative text-white p-2 mb-2" style={{ borderRight: "5px solid rgb(231,55,24)", backgroundColor: "rgba(120, 15, 0, 0.824)" }}>
            <div className="flex justify-between">
              ...
              <div className="dispatch-icon-warrper">
        ...
        container={containerRef.current}
      > 
        <div onClick={handleClick} className="relative text-white p-2 mb-2" style={{ borderRight: "5px solid rgb(24, 127, 231)", backgroundColor: "rgba(0, 52, 100, 0.824)" }}>
          <div className="flex justify-between">
            <div className="flex flex-1">
              <Chip color="primary" size="small" label={data.id}></Chip>
              {data.code != null ? (
...
const Item = ({options}) => {
  ...
  return (
    ...
    <div id="notificationColumn" style={{marginTop:'2.1%'}} className="flex break-words items-center">
