...
const AbdtApp: React.FC = () => {
    const [hoverId, setHoverId] = useRecoilState(activeHoverIdState)
    const [abdtDrivers, setAbdtDrivers]: any = useRecoilState(phoneAbdtDrivers)
    ...
    return (
        <>
            <div className='abdultaxi-container'>
                <div className="abdultaxi-driverslist" style={{ zIndex: 500 }}>
                    <img className='logo' src="https://dvexdev.github.io/DveX.Images/N8WKYwD.png" alt="logo" />
                    <div className='banner'><Typography style={{color: '#fff',wordBreak: 'break-word'}} variant='body1'>Available Drivers</Typography></div>
                    <div className='drivers'>
                        {abdtDrivers.map((data) => {
                            return (
