...
RPC.register('erp_laptop:gangs:checkInGang', function(source)
    local src = source
    local Gang = Gangs.CheckInGang(src)
    return Gang
end)

RPC.register('erp_laptop:gangs:checkRank', function(source)
    local src = source

    return Gangs.RankCheck(src)
end)

RPC.register('erp_laptop:gangs:fetchGang', function(source)
    local src = source

    return Gangs.GangData(src)
end)

RPC.register('erp_laptop:gangs:fetchRole', function(source, data)
