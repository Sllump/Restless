...
RPC.register('erp_laptop:gangs:createRank', function(source, data)
    Ranks.CreateRank(source, data)
end)

RPC.register('erp_laptop:gangs:deleteRank', function(source, data)
    Ranks.DeleteRank(source, data)
end)

RPC.register('erp_laptop:gangs:updateRank', function(source, data)
