SpraysContest = {
    ...
    ContestThread = function(src, Id, Model, GangName, SprayId, Name)
        ...
        TriggerClientEvent('erp_laptop:gangs:updateAllSprays', -1)
    end,
...
RPC.register('erp_laptop:sprays:startContesting', function(source, Id, Spray, Name)
    local src = source
    SpraysContest.startContesting(src, Id, Spray, Name)
end)

RPC.register('erp_laptop:sprays:cancelContest', function(source, Id)
    local src = source
    SpraysContest.cancelContest(src, Id)
end)

RPC.register('erp_laptop:sprays:beingContested', function(source, Id)
    local src = source
