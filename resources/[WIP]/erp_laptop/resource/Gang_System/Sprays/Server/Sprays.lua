RPC.register('erp_laptop:gangs:getSprayModel', function(source)
    local src = source
    return Gangs.FetchGang(src).sprayModel
end)

RPC.register('erp_laptop:gangs:syncPlaceSpray', function(source, Array)
    local src = source
    ...
    TriggerClientEvent('erp_laptop:gangs:syncClientSpray', -1, Spray)
...
RPC.register('erp_laptop:gangs:getAllSprays', function(source)
    local src = source
    ...
    for k, v in ipairs(Select) do
        ...
        TriggerClientEvent('erp_laptop:gangs:syncClientSpray', src, Sprayz)
    end
end)