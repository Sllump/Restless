...
export const Laptop: React.FC = () => {
    ...
    const fetchData = async () => {
        if (!Open) { return; }
        const result = await fetchNui("erp_laptop:fetchData");
    ...
    const InGang = async () => {
        const gangs = await fetchNui('erp_laptop:fetchInGang')
    ...
    useNuiEvent("erp_laptop:toggleLaptop", () => {
        setOpen(!Open);
    })

    useNuiEvent('erp_laptop:closeAllApps', () => {
        setNavigationState({
            path: 'Home',
        });
    })

    useNuiEvent("erp_laptop:gangs:checkInGang", () => {
        InGang();
    })
    ...
    useEffect(() => {
        const handleKeyDown = (e: KeyboardEvent) => {
            if (e.key === "Escape") {
                setOpen(false);
                fetchNui("erp_laptop:closeLaptop");
            }
        };
    ...
    useNuiEvent('erp_laptop:main:update', () => {
        fetchData();
    })
