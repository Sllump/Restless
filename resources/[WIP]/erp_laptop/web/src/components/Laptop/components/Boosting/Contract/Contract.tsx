...
export const Contract: React.FC = () => {
    ...
    const fetchData = async () => {
        const result = await fetchNui('erp_laptop:fetchContracts')
    ...
    useNuiEvent('erp_laptop:boosting:updateContracts', (data) => {
        if (data) {
            setContracts(data)
        }
    })
                                                    ...
                                                    <>
                                                        ...
                                                        <Button
                                                            ...
                                                            onClick={() => {
                                                                ...
                                                                fetchNui('erp_laptop:boosting:cancelContract', {
                                                                    Id: data.Id
                                                                })
                                                            }}
                                                        >
                ...
                >
                    ...
                    <DialogActions>
                        <Button
                            ...
                            onClick={() => {
                                setStartDialogOpen(false);
                                fetchNui('erp_laptop:boosting:startBoost', {
                                    Type: 'Regular',
                                ...
                                <Button
                                    ...
                                    onClick={async() => {
                                        ...
                                        setTimeout(async() => {
                                            ...
                                            await fetchNui('erp_laptop:boosting:transferContract', {
                                ...
                                <Button
                                    ...
                                    onClick={async() => {
                                        ...
                                        setTimeout(async() => {
                                            ...
                                            await fetchNui('erp_laptop:boosting:declineContract', {
