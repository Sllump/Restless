...
export const Gangs: React.FC = () => {
    ...
    const InitializeGang = async () => {
        const GangData = await fetchNui('erp_laptop:gangs:fetchGang')
    ...
    const fetchData = async () => {
        const Character = await fetchNui('erp_laptop:gangs:fetchCharacterData')

        if (Character) {
            const roleData = await fetchNui('erp_laptop:gangs:getRoleData', {
                Role: Character.Rank,
    ...
    useNuiEvent('erp_laptop:gangs:fetchGang', () => {
        InitializeGang();
    })
                        ...
                        >
                            ...
                            {!permissions &&
                                <Button
                                    ...
                                    onClick={async() => {
                                        await fetchNui('erp_laptop:gangs:leaveGang', {
                                            Gang: Gang.GangName
                                        })
                                ...
                                <Button
                                    ...
                                    onClick={async () => {
                                        ...
                                        setTimeout(async() => {
                                            ...
                                            await fetchNui('erp_laptop:gangs:addMember', {
                                                GangName: Gang.GangName,
                                                Rank: rank,
                                                stateId: stateId
                                            })
