...
------
RPC.register('InteractSound_SV:PlayOnOne', function(source, clientNetId, soundFile, soundVolume)
...
------
RPC.register('InteractSound_SV:PlayOnSource', function(source, soundFile, soundVolume)
...
------
RPC.register('InteractSound_SV:PlayOnAll', function(source, soundFile, soundVolume)
...
------
RPC.register('InteractSound_SV:PlayWithinDistance', function(source, maxDistance, soundFile, soundVolume)
